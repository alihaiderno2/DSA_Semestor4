...
/*
Function,   If A==B,    If A<B,If B<A,Cleanup
Union,  "Add one, move both",   "Add A, move i","Add B, move j",Add remaining from both
Difference, Move both,  "Add A,   move i",Move j,Add remaining from A
